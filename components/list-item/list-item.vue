		...
		<view class="item-view" @tap="onItemClickListener" @longtap="onItemLongClickListener">
			...
			<view :class="['cardshadow',isDelState?'item-del-background':'item-info']">
				...
				<view class="item-address">
					<text class="item-address-text">作业地点</text>
					<text class="item-address-content">{{itemData.address}}</text>
				</view>
			</view>
		</view>
		<image v-if="isCanDel" v-show="isDelState" @tap="deleteItem" src="../../static/delete@x2.png"
			style="width: 116.67rpx; height: 116.67rpx; position: absolute; top: 180rpx; margin-left: 300rpx;"></image>
	</view>
</template>
